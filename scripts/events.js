...
function workerFunction(e) {
    ...
    if (success) {
        if (message_type == "entries") {
             console.log("workerFunction:entries");
             ...
             console.log("workerFunction:pagination");
             ...
             console.log("workerFunction:socialdata");
             debug(`Received social data len:${result.length}`);
        }
        else if (message_type == "message") {
             console.log("workerFunction:message");
             if (result == "Creating database DONE") {
                console.log("workerFunction:message - creating");
                onSystemReady();
             }
             else if (result == "Worker - DONE") {
                console.log("workerFunction:message - done");
             }
             else {
                $('#statusLine').html(result);
                console.log("workerFunction:spinner");
             }
        }
    } else {
